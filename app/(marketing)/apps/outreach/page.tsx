...
import { CheckCircle2, ArrowRight, Phone, Zap, Shield, MessageSquare, TrendingUp } from "lucide-react"

const features = [
  { icon: Phone, title: "Outreach-Integration", description: "Verbinde IntroKI mit Outreach und synchronisiere automatisch alle Sequenzen, Templates und Campaign-Daten." },
  { icon: Zap, title: "Bidirektionale Synchronisation", description: "Synchronisiere Leads und Kontakte zwischen IntroKI und Outreach. Änderungen werden automatisch übertragen." },
  { icon: MessageSquare, title: "Sequence-Management", description: "Verwalte deine Outreach-Sequenzen direkt aus IntroKI heraus. Erstelle und bearbeite Templates nahtlos." },
  { icon: Shield, title: "Sichere Verbindung", description: "OAuth 2.0-Authentifizierung für maximale Sicherheit. Deine Sales-Daten bleiben geschützt." },
]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-jakarta font-medium tracking-tight text-text-primary mb-6">
              ...
              <br />
              <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Outreach</span>
            </h1>
            <p className="text-xl text-text-secondary font-inter mb-12 max-w-3xl mx-auto">
              Synchronisiere deine Outreach-Sequenzen und Campaigns mit IntroKI. Verwalte alle Sales-Automation-Daten an einem Ort.
            </p>
