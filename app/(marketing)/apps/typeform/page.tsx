...
import { CheckCircle2, ArrowRight, FileText, Zap, Shield, Users, TrendingUp } from "lucide-react"

const features = [
  { icon: FileText, title: "Typeform-Integration", description: "Verbinde IntroKI mit Typeform und erstelle automatisch Leads aus Formular-Antworten." },
  { icon: Zap, title: "Automatische Lead-Erstellung", description: "Jede Typeform-Antwort wird automatisch als Lead in IntroKI erstellt. Keine manuelle Arbeit mehr erforderlich." },
  { icon: Users, title: "Intelligente Datenzuordnung", description: "Formularfelder werden automatisch zu IntroKI-Feldern gemappt. Custom Fields werden unterstützt." },
  { icon: Shield, title: "Sichere Verbindung", description: "Webhook-basierte Integration für maximale Sicherheit. Deine Formular-Daten bleiben geschützt." },
]

export default function AppTypeformPage() {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-jakarta font-medium tracking-tight text-text-primary mb-6">
              ...
              <br />
              <span className="bg-gradient-to-r from-pink-600 to-pink-800 bg-clip-text text-transparent">Typeform</span>
            </h1>
            <p className="text-xl text-text-secondary font-inter mb-12 max-w-3xl mx-auto">
              Erstelle automatisch Leads aus Typeform-Antworten. Jede Formular-Submission wird automatisch zu einem Lead in IntroKI.
            </p>
