            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-full border border-border-active bg-surface backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white/20 font-inter"
                />
              </div>
            </div>
          </motion.div>
            ...
            {helpCategories.map((category, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-8 rounded-2xl border border-border-subtle bg-surface backdrop-blur-sm hover:shadow-xl transition-all cursor-pointer"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-text-secondary font-inter mb-4">{category.description}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {popularArticles.map((article, index) => (
                <motion.div
                  ...
                  className="p-4 rounded-xl bg-surface backdrop-blur-sm border border-border-subtle hover:bg-surface transition-colors cursor-pointer"
                >
                  <div className="font-inter text-text-secondary">{article}</div>
                </motion.div>
              ))}
            </div>
          </div>
