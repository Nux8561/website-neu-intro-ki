                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#0B0C0E]/70 font-inter mb-4">{method.description}</p>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <form className="space-y-6">
                <div>
                  <label className="block text-sm font-inter text-[#0B0C0E]/70 mb-2">Name</label>
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-xl border border-[#0B0C0E]/20 bg-white focus:outline-none focus:ring-2 focus:ring-[#0B0C0E]/20 font-inter"
                  />
                </div>
                <div>
                  <label className="block text-sm font-inter text-[#0B0C0E]/70 mb-2">E-Mail</label>
                  <input
                    type="email"
                    className="w-full px-4 py-3 rounded-xl border border-[#0B0C0E]/20 bg-white focus:outline-none focus:ring-2 focus:ring-[#0B0C0E]/20 font-inter"
                  />
                ...
                <div>
                  <label className="block text-sm font-inter text-[#0B0C0E]/70 mb-2">Nachricht</label>
                  <textarea
                    rows={6}
                    className="w-full px-4 py-3 rounded-xl border border-[#0B0C0E]/20 bg-white focus:outline-none focus:ring-2 focus:ring-[#0B0C0E]/20 font-inter"
                  />
                </div>
                <Button size="lg" className="w-full bg-[#0B0C0E] text-white rounded-full">
