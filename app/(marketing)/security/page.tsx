            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-16">
              {certifications.map((cert, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-[#0B0C0E]/10 text-center"
                >
                  <div className="text-sm font-jakarta font-semibold text-[#0B0C0E]">{cert}</div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {securityFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <span className="font-inter text-[#0B0C0E]/80">{feature}</span>
                </motion.div>
              ))}
            </div>
          </div>
