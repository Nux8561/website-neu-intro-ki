                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-text-primary/50 font-mono text-sm">
                        v{entry.version}
                      </span>
                    </div>
                    <h2 className="text-2xl font-jakarta font-medium tracking-tight text-text-primary mb-2">
                      {entry.title}
                    </h2>
                    <div className="flex items-center gap-2 text-text-primary/50 font-inter text-sm mb-4">
                    ...
                    <ul className="space-y-2">
                      {entry.items.map((item, i) => (
                        <li
                          key={i}
                          className="flex items-center gap-3 text-text-primary/60 font-inter text-sm"
                        >
