                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full p-6 flex items-center justify-between text-left hover:bg-surface transition-colors"
                    >
                      <h3 className="text-text-primary font-jakarta font-medium pr-4">
                        {faq.q}
                      </h3>
                      <ChevronDown
                        className={`h-5 w-5 text-text-primary/50 flex-shrink-0 transition-transform ${
                          isOpen ? "rotate-180" : ""
                        }`}
                      />
                    </button>
