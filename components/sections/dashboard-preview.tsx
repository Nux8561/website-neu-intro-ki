            ...
            >
              {content.cards.map((card, index) => (
                <motion.div
                  ...
                  className="rounded-2xl border border-[#0B0C0E]/10 bg-[#0B0C0E]/5 backdrop-blur-sm p-6"
                >
                  <div className="mb-4">
                    <h3 className="text-sm font-mono text-[#0B0C0E]/50 uppercase tracking-wider mb-2">
                      {card.title}
                    </h3>
                    <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-jakarta font-medium tracking-tight text-[#0B0C0E]">
                        {card.value}
                      </span>
