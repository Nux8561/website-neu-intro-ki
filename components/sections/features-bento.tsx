...
import { Check, Mic, BarChart3, Globe, Users, Zap, ArrowRight } from "lucide-react";
      ...
      <div className="mx-auto max-w-[1200px] px-4">
        ...
        <div className="grid gap-6 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
          ...
          <motion.div 
            ...
            className="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-slate-200 bg-slate-50 md:col-span-2 md:row-span-2 shadow-sm hover:shadow-md transition-all"
          >
            <div className="p-8">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-[11px] font-medium text-blue-700">
            ...
            <div className="relative mt-auto h-64 w-full border-t border-slate-200 bg-white p-6">
              ...
              <div className="relative z-10 space-y-3">
                {/* Agent Item 1 */}
                <div className="flex items-center justify-between rounded-lg border border-slate-100 bg-white p-3 shadow-sm group-hover:translate-x-1 transition-transform duration-attio-fast ease-attio-ease-out">
                ...
                {/* Agent Item 2 */}
                <div className="flex items-center justify-between rounded-lg border border-slate-100 bg-white p-3 shadow-sm group-hover:translate-x-1 transition-transform duration-attio-fast ease-attio-ease-out delay-75">
                  <div className="flex items-center gap-3">
          ...
          <motion.div 
            whileHover={{ y: -4 }}
            transition={ENTERPRISE_SPRING}
            className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white md:col-span-1 md:row-span-1 shadow-sm hover:shadow-md transition-all"
          >
            ...
            <div className="flex h-full flex-col justify-between p-6">
              ...
              {/* Fake UI: Deal Card */}
              <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50 p-3 shadow-sm group-hover:scale-105 transition-transform duration-attio-fast ease-attio-ease-out">
          ...
          <motion.div 
            whileHover={{ y: -4 }}
            transition={ENTERPRISE_SPRING}
            className="group relative overflow-hidden rounded-xl border border-slate-200 bg-slate-900 md:col-span-1 md:row-span-1 shadow-sm hover:shadow-md transition-all"
          >
            <div className="flex h-full flex-col justify-between p-6">
              <div className="relative z-10">
                <div className="mb-3 inline-flex items-center gap-1.5 rounded text-[10px] font-medium text-blue-400">
                  <Mic className="h-3 w-3" /> Live Analysis
                </div>
