  ...
  const features = [
    {
      ...
      visual: "priorities",
      span: "lg:col-span-2 lg:row-span-2", // Großes Feature
    },
    {
      id: 2,
    ...
    },
    {
      ...
      visual: "call",
      span: "lg:col-span-2 lg:row-span-1", // Mittleres Feature
    },
    {
      id: 4,
      ...
      visual: "tasks",
      span: "lg:col-span-1 lg:row-span-1", // Kleines Feature
    },
    {
      id: 5,
      ...
      visual: "pipeline",
      span: "lg:col-span-3 lg:row-span-1", // Breites Feature
    },
    {
      id: 6,
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4">
        ...
        <motion.div
          ...
          className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 lg:grid-rows-3"
        >
