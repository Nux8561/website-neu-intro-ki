        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-[#0B0C0E]/5 backdrop-blur-md border border-[#0B0C0E]/10 rounded-2xl p-8 md:p-12"
            >
              <h3 className="text-3xl md:text-4xl font-jakarta font-medium tracking-tight text-[#0B0C0E] mb-4">
                ...
                {features[activeTab as keyof typeof features].items.map(
                  (item, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 text-[#0B0C0E]/80 font-inter"
                    >
