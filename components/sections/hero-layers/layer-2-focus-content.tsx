  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-black/5 px-4 py-2 text-xs font-space-grotesk font-medium text-black/80">
            <motion.span
        ...
        >
          ...
          <motion.span
            ...
            className="block mt-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-black/80 font-space-grotesk font-medium -tracking-[0.01em]"
          >
            {subline}
          </motion.span>
        </motion.h1>
        ...
        >
          {[
            { label: "60 Sek. Research", icon: Clock, color: "text-blue-600" },
            { label: "3x mehr Deals", icon: TrendingUp, color: "text-emerald-600" },
            { label: "100% DSGVO", icon: CheckCircle2, color: "text-black/80" },
          ].map((badge, i) => {
            ...
            return (
              <motion.div
                ...
                className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-space-grotesk font-medium text-black/80 shadow-sm"
              >
                <Icon className={`h-4 w-4 ${badge.color || "text-black/80"}`} />
        ...
        >
          <Link href="/demo" className="group">
            <MagneticButton
              variant="primary"
              className="bg-black text-white hover:bg-white hover:text-black border-2 border-black shadow-xl hover:shadow-2xl transition-all"
            >
              Demo buchen
          ...
          >
            <MagneticButton
              variant="secondary"
              className="border-2 border-black bg-white text-black hover:bg-black hover:text-white shadow-sm hover:shadow-md transition-all"
            >
              Wie es funktioniert
            </MagneticButton>
          </Link>
      ...
      <ParallaxContainer speed={0.6}>
        ...
        >
          <div className="overflow-hidden rounded-3xl border border-black/10 bg-white shadow-sm min-h-[60vh]">
            <div className="bg-gradient-to-br from-slate-50 to-white min-h-[60vh] flex">
              {/* SIDEBAR NAVIGATION */}
              <motion.aside
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ ...snappySpring, delay: 1.4 }}
                className="w-64 border-r border-black/10 bg-white p-4 flex flex-col"
              >
                <div className="mb-6">
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        {item.badge && (
                          <span className="text-xs font-mono font-bold bg-black/5 text-black px-2 py-0.5 rounded">
                            {item.badge}
                          </span>
                        )}
                      </motion.button>
                ...
                <div className="mt-auto pt-4 border-t border-black/10">
                  <div className="px-3 py-2 rounded-lg bg-emerald-100 border border-emerald-200">
                    <div className="flex items-center gap-2 mb-1">
                      <Activity className="h-3.5 w-3.5 text-emerald-600" />
                      <span className="text-xs font-space-grotesk font-semibold text-emerald-700">AI aktiv</span>
                    </div>
                    <p className="text-xs text-emerald-600 font-inter">3 Researchs laufen</p>
                  </div>
                </div>
              </motion.aside>
              ...
              <div className="flex-1 flex flex-col relative">
                ...
                {animationPhase === 0 && (
                  ...
                  >
                    <div className="bg-white rounded-xl border border-black/10 p-8 shadow-xl">
                      <div className="flex items-center gap-3 mb-4">
                ...
                {animationPhase >= 1 && (
                  ...
                  >
                    <motion.div
                      ...
                      className="rounded-lg bg-emerald-100 border border-emerald-200 px-4 py-2 shadow-sm"
                    >
                      <span className="text-xs font-space-grotesk font-semibold text-emerald-700">
                ...
                {animationPhase === 3 && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -20 }}
                    className="absolute top-20 right-4 z-40 bg-white rounded-xl border border-blue-200 p-4 shadow-xl"
                  >
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <motion.div
                      ...
                      className="rounded-full bg-emerald-100 border border-emerald-200 px-4 py-2 shadow-sm"
                    >
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {[
                      ...
                      <motion.div
                        ...
                        className="group rounded-xl border border-black/10 bg-white p-6 shadow-sm transition-all hover:shadow-md cursor-pointer"
                      >
                        {/* Priority Badge & Header */}
                        <div className="mb-4 flex items-start justify-between">
                          <div className="flex items-center gap-3 flex-1">
                            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-500 text-xs font-mono font-bold text-white tabular-nums">
                              #{deal.priority}
                            </div>
                          ...
                          <div className="rounded-full bg-black/5 border border-black/10 px-3 py-1.5">
