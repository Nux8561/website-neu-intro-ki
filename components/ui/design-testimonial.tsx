      ...
      <div ref={containerRef} className="relative w-full max-w-5xl" onMouseMove={handleMouseMove}>
        ...
        <div className="relative flex">
          ...
          <div className="flex flex-col items-center justify-center pr-16 border-r border-black/10">
            <motion.span
              className="text-xs font-mono text-black/60 tracking-widest uppercase"
          ...
          <div className="flex-1 pl-16 py-12">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="mb-8"
              >
                <span className="inline-flex items-center gap-2 text-xs font-mono text-black/60 border border-black/10 rounded-full px-3 py-1">
